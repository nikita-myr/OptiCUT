...
public class WindowsCutSheet
{
                                    ...
                                    string objectLabel = "объект", string constructionLabel = "В-X")
    {
        ...
        //Writing up details
        foreach (var whipField in positions)
        {
            ...
            GetDetails(worksheet, Core.Utilities.GetStackedDetails(whipField.Details));
    ...
    private static void GetDetails(Worksheet worksheet, ObservableCollection<Detail> details)
    {
        ...
        {
            worksheet.Cells["C" + _rawOffset].PutValue(detail.Lenght);
            worksheet.Cells["C" + _rawOffset].SetStyle(
                CellStyles.SetBasicCellStyle(worksheet.Cells["C" + _rawOffset]));

            worksheet.Cells["K" + _rawOffset].PutValue(detail.Amount);
