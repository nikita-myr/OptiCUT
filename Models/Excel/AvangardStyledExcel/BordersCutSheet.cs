...
public class BordersCutSheet
{
                                    ...
                                    string objectLabel, string constructionLabel)
    {
        ...
        worksheet.Name = "Ограждение";

        worksheet.Cells.Merge(0, 0, 1, 13);
        Cell headerCell = worksheet.Cells["A1"];
        worksheet.Cells["A1"].PutValue("Ограждаение");
        ...
        worksheet.Cells.Merge(_rawOffset - 1, 0, 1, 13);
        worksheet.Cells["A" + _rawOffset].PutValue("Ограждение. Оптимизация распила");
