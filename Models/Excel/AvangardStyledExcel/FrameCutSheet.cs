...
public class FrameCutSheet
{
        ...
        bool isNeedVsk213 = false, bool isNeedVsk214 = false, string objectLabel = "объект", string constructionLabel = "В-X")
    {
        ...
        if (isNeedVsk213) WriteVsk213Fields(worksheet, FrameCutterViewModel.vsk213Amount);
        if (isNeedVsk214) WriteVsk214Fields(worksheet, FrameCutterViewModel.vsk214Amount);
    ...
    private static void WriteVsk214Fields(Worksheet worksheet, int detailsAmount)
    {
        worksheet.Cells.Merge(_rawOffset - 1, 0, 1, 13);
        worksheet.Cells["A" + _rawOffset]
